...
# Admin configuration
LOGIN_URL = 'forneria:login'
LOGIN_REDIRECT_URL = 'forneria:dashboard_admin'
LOGOUT_REDIRECT_URL = 'forneria:login'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='no-reply@forneria.local')
